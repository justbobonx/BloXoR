class BloxPhysics {
  ...
  updateTheBlox(aBlox) {
    ...
    let potNewX = Math.trunc((aBlox.pos.x + aBlox.vel.x) * g.BLOX_POS_PRECISION) / g.BLOX_POS_PRECISION;
    let potNewY = Math.trunc((aBlox.pos.y + aBlox.vel.y) * g.BLOX_POS_PRECISION) / g.BLOX_POS_PRECISION;
